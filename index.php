...
<section class="rev_slider_wrapper">
  <div id="slider1" class="rev_slider">
    <ul>
      <li><img src="images/slider_images/slider-1.png" alt=""></li>
      <li><img src="images/slider_images/slider-2.png" alt=""> </li>
      <li><img src="images/slider_images/slider-3.png" alt=""> </li>
    ...
    <div class="item-box">
      <div class="row">
        <div class="single-column col-md-6 ">
          <div class="wow fadeIn" data-wow-duration="2s" data-wow-delay="0.5s" data-wow-offset="0"
            style="visibility: visible; animation-duration: 2s; animation-delay: 0.5s; animation-name: fadeIn;">
            <div class="post-content">
              <div class="sec-title">
                <h2>Welcome to ISRAJIDEVI ENGLISH MEDIUM SCHOOL</h2>
              </div>
              <div class="text">
                <p style="text-align:justify;">ISRAJIDEVI ENGLISH MEDIUM SCHOOL is an amicable school where
                  students enjoy learning. It follows a co-education system of education from classes 1 to 12th| based
                  On the norms of the CBSE. In the year 2022, ISRAJIDEVI ENGLISH MEDIUM SCHOOL was set up in Jaunpur in
                  collaboration with the General Council of Delhi. The school follows the CBSE curriculum. Kids Academy
                  ensures a holistic approach towards development of the Students to all sections of the society
                  regardless of their financial Status, caste or creed.
                  <!-- The school which began with 85 students on its roll now has 2565 students and a
                  highly experienced teaching faculty consisting of 50 teachers. -->
                  Our vision is to grow great citizens, empowered to Live successfully in their personal and global
                  lives. We ensure committed, dedicated and caring staffs who strive to make your child's learning and
                  Social experiences fun and meaningful. We offer opportunities for international exposure through
                  overseas sports exchanges and by inviting Indian and foreign teams to the campus.
                  .
                </p>
              </div>
              <ul class="link_btn">
        ...
        <div class="row">
          <div class="single-column col-md-6 ">
            <img src="images/background/about.jpg" height="60%" class="img-responsive about_right_god" alt="school">
          </div>
        </div>
      </div>
    </div>
                  ...
                  <div class="custom-calendar-wrap">
                    <div id="custom-inner" class="custom-inner">
                      <div class="w3ls-header">
                        <nav style="position: initial;"> <span id="custom-prev" class="custom-prev"></span> <span
                            id="custom-next" class="custom-next"></span> <span id="custom-current"
                            class="custom-current" title="Go to current date"></span> </nav>
              ...
              <ul class="list-group list-group-flush" style="overflow-y:auto; height: 350px;width:auto;">
                ...
                ?>
                    <?php // if ($value1->pdf_status == "Uploaded") { ?>
                      <!-- <li class="list-group-item"><a href="<?php //echo $NOTIFICATION_PDF_PATH . $value1->id . ".pdf" ?>"
                          style="text-decoration:underline;" target="_blank"><?php //echo $value1->n_title; ?></a></li>
                    <?php //} else { ?>
                      <li class="list-group-item"><a href="#" style="text-decoration:underline;">
      ...
      <div class="row">
        <div class="column col-md-4 col-sm-12"> <a href="#" class="item left">
          ...
          <a href="#" class="item left">
            <div class="icon"><span class="fa fa-desktop"></span> </div>
            <h4>Vision</h4>
            <p style="text-align:justify;">Our quest is to create an educational system of useful individualized
              learning that stimulates passion and brilliance in every child.</p>
          </a>
          <a href="#" class="item left">
            <div class="icon"><span class="fa fa-desktop"></span> </div>
            <h4>Mission</h4>
            <p style="text-align:justify;">ISRAJIDEVI ENGLISH MEDIUM SCHOOL always makes innumerable efforts to
              make the students come up with highest quality of education, incorporating right blend of personal
              integrity and the fundamental values. We work together in making the students extraordinaire in scholastic
              & co-scholastic area..</p>
          </a>
        </div>
        <div class="column col-md-4 col-sm-12"> <a href="#" class="item left">
            <div class="icon"><span class="fa fa-child"></span> </div>
            <h4>Education</h4>
            <p style="text-align:justify;">The foundation of every nation is education. We believe that the objective of
              education is to prepare the young minds to be innovative thinkers and quick learners.</p>
          </a> <a href="#" class="item left">
            <div class="icon"><span class="fa fa-book"></span> </div>
            <h4>College Library</h4>
            <p style="text-align:justify;">Strict silence should be observed inside the Library and in the vicinity at
              all... </p>
          </a> <a href="#" class="item left">
            <div class="icon"><span class="fa fa-comments"></span> </div>
            <h4>Multi Purpose Halls</h4>
            <p style="text-align:justify;">The school has an Airconditioned hall for general meetings and convocation...
            </p>
          </a> </div>
        <div class="column col-md-4 col-sm-12"> <a href="#" class="item left">
            <div class="icon"><span class="fa fa-child"></span> </div>
            <h4>Prayer Room</h4>
            <p style="text-align:justify;">"It is good to give thanks to the Lord To sing praises to Your name,O Most
              High...</p>
          </a> <a href="#" class="item left">
            <div class="icon"><span class="fa fa-music"></span> </div>
            <h4>Technology</h4>
            <p style="text-align:justify;">Technology has now become a necessity for the generation next. It has to be
              integrated with education so that students keep pace with the ever changing global scenario. </p>
          </a> <a href="#" class="item left">
            <div class="icon"><span class="fa fa-futbol-o"></span> </div>
            <h4>Sports</h4>
            <p style="text-align:justify;">The school Provide all the sports facilities with trained sports teacher,
              ISRAJIDEVI ENGLISH MEDIUM SCHOOL Mungra Badshahpur Jaunpur U.P. has the vision to use sports as tools
              for joyful learning and personality shaping. The school lays special emphasis on sports & fitness.</p>
          </a> </div>
      </div>
    </div>
  </div>
