      ...
      <div class="container-fluid">
        ...
        <?php if(isset($_SESSION['gallery_delete_success'])){ ?>
                 ...
                 <div class="alert alert-success rounded-0" id="success-alert" role="alert">
                  ...
                  unset($_SESSION['gallery_delete_success']); ?>
                 </div>
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Gallery records</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item">Media & Gallery</li>
              <li class="breadcrumb-item active">Gallery Records</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Gallery records</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td class="col-md-1">
                      <form action="action/delete_gallery_post.php" method="post">
                      <input type="hidden" name="id" value="<?php echo $value1->id; ?>">
                      <button type="submit" name="delete" class="btn btn-danger"><i class="far fa-trash-alt pr-2"></i>Delete</button>
                     </form>
                    </td>
                  </tr>
